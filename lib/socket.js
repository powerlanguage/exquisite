...
function broadcastGameUpdate(playerId) {
  const currentPlayer = getPlayer(playerId);
  const personalizedGame = { ...game, currentPlayer };
  broadcast(JSON.stringify({ type: "update game", payload: personalizedGame }));
}
